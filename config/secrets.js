...
module.exports = {
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1409470732679541',
    clientSecret: process.env.FACEBOOK_SECRET || '2eef180f836291b467756c9b8b02ad38',
    callbackURL: '/auth/facebook/callback',
    passReqToCallback: true
  },

  google: {
    clientID: process.env.GOOGLE_ID || '954770333431-kmcrcjp1p4q8mft2r036rk6safhg5rnu.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'I0TzPaKn4NFjvib9HGPe3OXu',
